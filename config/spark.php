...
return [
    ...
    */
    ...
    'path' => 'billing',
    'dashboard_url' => env('FRONTEND_URL', 'http://localhost:3000'),
    ...
    'billables' => [
        ...
        'user' => [
            ...
            'plans' => [
                [
                    'name' => 'Premium',
                    'short_description' => 'Use pomodoro more beautifully and without limits',
                    'monthly_id' => 'price_1J2VPmJEbl1PKejzTEKLmsXq',
                    'yearly_id' => 'price_1J2VPmJEbl1PKejzduO3aM7M',
                    'features' => [
                        'No tasks limits',
                        'Dark theme',
                    ],
